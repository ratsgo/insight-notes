...
## **표2** 입력 토큰 벡터들과 트랜스포머 출력 벡터 간 상호정보량
{: .no_toc .text-delta }
...
## **표3** 태스크가 다른 모델 간 거리 측정 방법과 그 결과
{: .no_toc .text-delta }
...
## **표4** 토큰 representation의 레이어별 변화량
{: .no_toc .text-delta }
...
## **표8** 태스크별/레이어별 토큰 representation 시각화
{: .no_toc .text-delta }
...
## **표10** 'it'의 태스크별/레이어별 representation 시각화
{: .no_toc .text-delta }
